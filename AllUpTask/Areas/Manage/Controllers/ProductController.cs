    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Create(Product product)
        {
            ...
            if (product.ProductPosterImageFile != null)
            {
                ...
                {
                    ModelState.AddModelError("ProductPosterImageFile", "can only upload .png or .jpeg");
                    return View();
                }
                ...
                {
                    Product = product,
                    ImageUrl = Helper.SaveFile(_env.WebRootPath, "upload/products", product.ProductPosterImageFile),
                    IsPoster = true
                };
            ...
            if (product.ImageFiles != null)
            {
                foreach (var imageFile in product.ImageFiles)
                {
                    ...
                    {
                        ModelState.AddModelError("ImageFiles", "can only upload .png or .jpeg");
                        return View();
                    }
